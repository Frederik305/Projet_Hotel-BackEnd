// Licence file C:\Users\2238026\Documents\ReversePOCO.txt not found.
...
namespace Projet_Hotel_CodeBase
{
    ...
    public class MyDbContext : DbContext, IMyDbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer(@"data source=GA-VIR-2238026\SQLEXPRESS;initial catalog=HotelDB;trusted_connection=true;Integrated Security=True;Encrypt=False");
            }
        }
